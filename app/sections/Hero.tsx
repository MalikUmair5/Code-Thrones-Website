  ...
  return (
    <main className="lg:px-20 xs:px-3 md:px-10 lg:py-2 md:py-0">
      <div className=" flex items-center xs:flex-wrap md:flex-nowrap">
        ...
        <div className=" w-[600px] lg:h-[500px] z-[-1] bg-[#2F80ED] lg:absolute top-0 right-0 lg:flex items-center justify-center text-white lg:rounded-bl-[200px] sm:flex sm:rounded-bl-[0px] md:rounded-md md:h-auto md:p-5 lg:rounded-none">
